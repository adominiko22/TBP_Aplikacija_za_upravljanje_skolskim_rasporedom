...
BEGIN
    ...
    FROM program_track
    WHERE name = 'Prirodoslovno-matematička gimnazija';

    IF v_track_id IS NULL THEN
        RAISE EXCEPTION 'Nedostaje track: Prirodoslovno-matematička gimnazija (program_track).';
    END IF;

    FOR g IN 1..4 LOOP
        INSERT INTO school_class (school_year, grade_level, label, track_id)
        VALUES (v_year, g, 'C', v_track_id)
